...
def main():
  ...
  stocks_name = ['Asian_Paints', 'Axis_Bank', 'Bajaj_Finance', 'DRL', 'ICICI_Bank', 'Induslnd_Bank',
  ...
  stocks_name = ['Apollo_Hospitals', 'Bajaj_Auto', 'Britannia_Industries', 'Hero_MotoCorp', 'Infosys',
  ...
  stocks_name = ['Ambuja_Cements', 'Bosch', 'Dixon_Tech', 'Havells_India', 'InfoEdge_India',
