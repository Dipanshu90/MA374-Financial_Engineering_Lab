...
def getPredictedPrices(S):
    ...
    predictedPrices = []
    for i in range(246):  # 246 = 1238 - 992 (number of future points to predict)
...
def main():
    ...
    for i in range(columnHeaders.shape[0]):
        ...
        dataTrain = dataActual[:992]  # Train data represents data till 31 Dec 2022
